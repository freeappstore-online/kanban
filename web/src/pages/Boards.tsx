...
import { listBoards, saveBoard, deleteBoard, newBoard } from '../lib/storage'
...
export function Boards({ user, onOpen }: BoardsProps) {
  ...
  return (
    <div className="min-h-[100dvh]">
      ...
      <main className="mx-auto max-w-[1540px] px-4 py-8 sm:px-6">
        <h1 className="display-font text-2xl font-bold text-[var(--ink)]">Your boards</h1>
